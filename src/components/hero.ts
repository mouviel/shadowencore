import { GAME_DOWNLOAD } from './downloadModal.ts'

export function Hero(): string {
  return `
    <section class="max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8 mx-auto w-full relative pt-32 sm:pt-36 lg:pt-40 mb-8 sm:mb-12 scroll-mt-28" data-aos="fade-up">
      ...
      <div class="grid lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-2 order-2 lg:order-1" data-aos="fade-right" data-aos-delay="100">
          ...
          <div class="relative mb-3 sm:mb-4 group" id="main-display">
            ...
            <video id="main-video" 
              ...
              title="Razor Shard official game trailer"
          ...
          <div class="relative flex gap-2 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide">
            ...
            <img src="/assets/images/gameplay1.jpg" alt="Razor Shard gameplay screenshot 1 - Blu fighting corrupted enemies" class="w-32 h-24 sm:w-36 sm:h-28 object-cover rounded-md cursor-pointer hover:opacity-80 transition-all thumbnail-item border-2 border-transparent snap-start" data-type="image" data-src="/assets/images/gameplay1.jpg" loading="lazy">
            <img src="/assets/images/gameplay2.jpg" alt="Razor Shard gameplay screenshot 2 - Platforming challenges in Talpa" class="w-32 h-24 sm:w-36 sm:h-28 object-cover rounded-md cursor-pointer hover:opacity-80 transition-all thumbnail-item border-2 border-transparent snap-start" data-type="image" data-src="/assets/images/gameplay2.jpg" loading="lazy">
            <img src="/assets/images/gameplay3.jpg" alt="Razor Shard gameplay screenshot 3 - Ancient Guardian abilities" class="w-32 h-24 sm:w-36 sm:h-28 object-cover rounded-md cursor-pointer hover:opacity-80 transition-all thumbnail-item border-2 border-transparent snap-start" data-type="image" data-src="/assets/images/gameplay3.jpg" loading="lazy">
            <img src="/assets/images/gameplay4.jpg" alt="Razor Shard gameplay screenshot 4 - Corrupted world environments" class="w-32 h-24 sm:w-36 sm:h-28 object-cover rounded-md cursor-pointer hover:opacity-80 transition-all thumbnail-item border-2 border-transparent snap-start" data-type="image" data-src="/assets/images/gameplay4.jpg" loading="lazy">
          ...
          <div id="about" class="mt-12 sm:mt-16 max-w-4xl mx-auto scroll-mt-28" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="prose prose-sm sm:prose-lg max-w-none text-gray-700 dark:text-gray-300">
              <p class="text-base sm:text-lg leading-relaxed mb-4 sm:mb-6 text-gray-700 dark:text-gray-300">
                The noble Guardians who upheld balance in Talpa, have all but fallen to corruption. The fate of the world now rests in the last of this dying order. Welcome to <strong class="text-gray-800 dark:text-gray-100">Razor Shard</strong>, where the fate of an entire world hangs in the balance.
              </p>
              ...
              <p class="leading-relaxed text-gray-700 dark:text-gray-300">
                Whether you're a seasoned platformer or new to the genre, Razor Shard offers the perfect blend of challenging gameplay, atmospheric storytelling, and beautiful hand-crafted environments. Join Blu in her quest to restore the world of Talpa and become the Guardian this corrupted realm desperately needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="lg:col-span-1 order-1 lg:order-2" data-aos="fade-left" data-aos-delay="150">
          ...
          <div class="mb-4 sm:mb-6 text-center lg:text-left">
            <h1 class="text-2xl sm:text-3xl lg:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4">Razor Shard</h1>
          </div>
          
          <!-- Game Description -->
          <div class="mb-4 sm:mb-6">
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base text-center lg:text-left">
              Lead Blu, a young Guardian, through a corrupted Talpa: precision platforming, ancient abilities, and oppressive atmosphere—optionally with a friend in local co-op.
            </p>
          </div>

          <!-- Game Action Buttons -->
          <div id="download" class="mb-4 sm:mb-6 space-y-3 scroll-mt-28">
            <button type="button" onclick="downloadGame()" class="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 dark:from-emerald-400 dark:to-green-500 dark:hover:from-emerald-500 dark:hover:to-green-600 text-white px-4 sm:px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 text-sm sm:text-base focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-emerald-400 dark:focus-visible:ring-offset-slate-900">
              Download Now
            </button>
          </div>
          ...
          <div class="mb-4 sm:mb-6 space-y-3">
            ...
            <div class="flex justify-between items-start gap-2">
              <span class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 uppercase shrink-0">Archive password:</span>
              <span class="text-gray-800 dark:text-gray-200 font-mono font-medium text-sm sm:text-base text-right break-all">${GAME_DOWNLOAD.password}</span>
            </div>
            <div class="flex justify-between items-start">
  ...
  thumbnailItems.forEach((item) => {
    item.addEventListener('click', (e) => {
      ...
      thumbnailItems.forEach(thumb => {
        thumb.classList.remove('border-cyan-500', 'border-cyan-400')
